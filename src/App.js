      ...
      <BrowserRouter>
        <Routes>
          <Route path="/">
            ...
            <Route path="provider" element={<Provider user={currentUser} />}/>
            <Route
              index
              element={
            ...
            <Route path="payment/success" element={ <RequireAuth>
                 <Success/>
                </RequireAuth>}/>
            <Route path='profile'element= { <RequireAuth>
                 <Profile/>
                </RequireAuth>}/>
            <Route path="payment/cancel" element={ <RequireAuth>
                 <Cancel/>
                </RequireAuth>}/>
            <Route path="providerlogin" element={ <RequireAuth>
