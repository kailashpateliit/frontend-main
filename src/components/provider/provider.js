...
const Provider = ({user}) => {
    ...
    const handleSubmit= async(e)=>{
        e.preventDefault();
        await axios.post("http://localhost:5000/provider",provider)
        .then(res=>{
            console.log(res);
    ...
    return ( 
        ...
        <form className='m-4 properform bg-dark form-control rounded'>
            <h1 className='text-info mb-4'>Enter your Details</h1>
            <div className="row">
                <div className="form-group col-md-6">
                <label>Name</label>
                <input type="text" className="form-control" name="lng"  onChange={handleChange}  placeholder="Email" />
                </div>
                <div className="form-group col-md-6">
                <label>Email</label>
